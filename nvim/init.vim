...
Plug 'Xuyuanp/nerdtree-git-plugin' "highlights files that have been updated
...
Plug 'vim-airline/vim-airline' "bottom display
...
:highlight LineNr ctermfg=grey "line number color
...
"autocmd! VimEnter * NERDTree | wincmd w "switch to empty buffer on open
